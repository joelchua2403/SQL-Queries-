...
select categories_dishes.dish_id, dish.name as name, COUNT(categories_dishes.dish_id) as dish_count
...
select max(review.rating) as best_rating, review.description 
from review
